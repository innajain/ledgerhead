...
export async function createIncomeSource(data: { name: string; group: string; note?: string }): Promise<income_source> {
...
export async function updateIncomeSource(id: string, data: { name?: string; group?: string; note?: string }): Promise<income_source> {
